...
import { IoBatteryCharging, IoShieldCheckmarkSharp } from "react-icons/io5";
import { GiScallop } from "react-icons/gi";
import { MdSpaceDashboard } from "react-icons/md";

export const features = [
  {
    icon: <RiRobot2Fill size={40}  className="text-orange-500"  />,
    text: "Drag-and-Drop Interface",
    description: "Easily design and arrange your VR environments with a user-friendly drag-and-drop interface.",
  },
  {
    icon: <FaFingerprint size={40}  className="text-orange-500"  />,
  ...
  {
    icon: <IoBatteryCharging size={40}  className="text-orange-500"  />,
  ...
  {
    icon: <IoIosTime size={40}  className="text-orange-500"  />,
  ...
  {
    icon: <GiScallop size={40}  className="text-orange-500"  />,
  ...
  {
    icon: <MdSpaceDashboard size={40} className="text-orange-500" />,
